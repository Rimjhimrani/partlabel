...
def automate_location_assignment(df, base_rack_id, rack_configs, status_text=None):
    ...
    for station_no, station_group in df_processed.groupby('Station No', sort=False):
        ...
        # CONFIRMATION: The rack, level, and cell counters are RESET here for each new station.
        # This ensures that if the first station is ST-150, it starts at Rack 01,
        # and when the next station (e.g., ST-160) is processed, it ALSO starts from Rack 01.
